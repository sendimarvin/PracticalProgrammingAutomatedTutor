...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 17, 2018 at 02:39 PM
...
INSERT INTO `studentsubmissions` (`id`, `email`, `problemId`, `submission`, `result`) VALUES
(8, 's@gmail.com', 2, 'submissionUpdate', 'resultsUpdate'),
(7, 's@gmail.com', 1, 'submissionUpdate', 'resultsUpdate');
...
('s2@gmail.com', 'Micheal', 'Omar', 's2', 'student'),
('sendimarvin1@gmail.com', 'Marvin', 'Sendikaddiwa', 'Aurora1!', 'student'),
('a@gmail.com', 'a', 'a', 'a', 'admin'),
('s@gmail.com', 'Judith', 'Aryatwijuka', 's', 'student'),
('s1@gmail.com', 'Augustine', 'Abule', 's1', 'student'),
...
--
-- AUTO_INCREMENT for table `studentsubmissions`
--
ALTER TABLE `studentsubmissions`
